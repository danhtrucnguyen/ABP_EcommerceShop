...
namespace Ecommerce_Shop.Migrations
{
    ...
    [Migration("20250923042852_Relax_Review_ConcurrencyStamp")]
    partial class Relax_Review_ConcurrencyStamp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Order", b =>
                {
                    b.HasOne("Ecommerce_Shop.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.OrderItem", b =>
                {
                    b.HasOne("Ecommerce_Shop.Entities.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ecommerce_Shop.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce_Shop.Entities.Product", b =>
                {
                    b.HasOne("Ecommerce_Shop.Entities.Category", "Category")
                        .WithMany()
