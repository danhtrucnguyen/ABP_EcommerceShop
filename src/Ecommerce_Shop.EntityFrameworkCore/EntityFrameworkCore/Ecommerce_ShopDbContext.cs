...
public class Ecommerce_ShopDbContext :
    AbpDbContext<Ecommerce_ShopDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(Ecommerce_ShopConsts.DbTablePrefix + "YourEntities", Ecommerce_ShopConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});

        builder.Entity<Entities.Product>(b =>
        {
